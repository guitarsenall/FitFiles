...
# WHS 6/11/18 convert left_right_balance
def _convert_balance(raw_data):
    ...
    if right:
        ...
        return 100-value    # assume value is left-side

# WHS 6/19/18 convert left_right_balance_100
def _convert_balance_100(raw_data):
    ...
    if right:
        ...
        return 100-value/100.0    # assume value is left-side
